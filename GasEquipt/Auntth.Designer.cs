namespace GasEquipt
{
	partial class Auntth
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Auntth));
			...
			this.loginTableAdapter = new GasEquipt.gazmechDataSetTableAdapters.loginTableAdapter();
			...
			this.loginBindingSource.DataSource = this.gazmechDataSet;
			// 
			// loginTableAdapter
			// 
			...
			this.ClientSize = new System.Drawing.Size(179, 310);
			...
			this.Text = "Вход";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.Auntth_FormClosed);
			this.Load += new System.EventHandler(this.Auntth_Load_1);
		...
		private gazmechDataSetTableAdapters.loginTableAdapter loginTableAdapter;
